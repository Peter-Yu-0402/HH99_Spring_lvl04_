...
import com.sparta.hh99springlv4.user.security.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authorizeHttpRequests) ->
                authorizeHttpRequests
                        ...
                        .requestMatchers("/api/lecture/select/**").permitAll() // '/api/lecture/select/'로 시작하는 요청 모두 접근 허가
                        .requestMatchers("/api/lecture/category/**").permitAll() // '/api/lecture/category/'로 시작하는 요청 모두 접근 허가
